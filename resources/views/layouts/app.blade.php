...
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/imgs/logo/univape-logo.png')}}">
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="{{route('home.index')}}"><img src="assets/imgs/logo/univape-logo.png" alt="logo"></a>
                    </div>
                            ...
                            <div class="categori-dropdown-wrap categori-dropdown-active-large">
                                <ul>
                                    <li class="has-children">
                                        <a href="shop.html"><i class="surfsidemedia-font-dress"></i>Liquid</a>
                                                ...
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                <li><span class="submenu-title">Saltnic</span></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Fruit</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Creamy</a></li>
                                                            </ul>
                                                            <ul>
                                                                <li><span class="submenu-title">Freebase</span></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Fruit</a></li>
                                                                <li><a class="dropdown-item nav-link nav_item" href="#">Creamy</a></li>
                                                            </ul>
                                                        </li>
                                    ...
                                    <li class="has-children">
                                        <a href="shop.html"><i class="surfsidemedia-font-tshirt"></i>Device</a>
                                        <div class="dropdown-menu">
                                            <ul class="mega-menu d-lg-flex">
                                                <li class="mega-menu-col col-lg-7">
                                                    <ul class="d-lg-flex">
                                                        <li class="mega-menu-col col-lg-6">
                                                            <ul>
                                                                <li><span class="submenu-title">Device</span></li>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="widget-about font-md mb-md-5 mb-lg-0">
                            <div class="logo logo-width-1 wow fadeIn animated">
                                <a href="index.html"><img src="assets/imgs/logo/univape-logo.png" alt="logo"></a>
                            </div>
                            <h5 class="mt-20 mb-10 fw-600 text-grey-4 wow fadeIn animated">Contact</h5>
                            <p class="wow fadeIn animated">
                                <strong>Address: </strong>Malang City
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Phone: </strong>+62 0000-000-000
                            </p>
                            <p class="wow fadeIn animated">
                                <strong>Email: </strong>contact@vapestore.in
                            </p>

                                    ...
                                    <div class="detail-gallery">
                                        ...
                                        <div class="product-image-slider">
                                            <figure class="border-radius-10">
                                                <img src="{{ asset('assets/imgs/shop/product-')}}{{$product->id}}.webp" alt="product image">
                                            </figure>
                                            <figure class="border-radius-10">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="detail-info">
                                        ...
                                        <ul class="product-meta font-xs color-grey mt-50">
                                            ...
                                            <li>{{$product->stock_status}}<span class="in-stock text-success ml-5">{{$product->quantyty}}</span></li>
                                        </ul>
                                    </div>
                                    <!-- Detail Info -->
                                </div>
                                                ...
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{route('product.details',['slug'=>$rproduct->slug])}}" tabindex="0">
                                                            <img class="default-img" src="{{ asset('assets/imgs/shop/product-')}}{{$rproduct->id}}.webp" alt="{{$rproduct->name}}">
                                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-')}}{{$rproduct->id}}.webp')}}" alt="">
                                                        </a>
                                                    </div>
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{ asset('assets/imgs/shop/product-')}}{{$nproduct->id}}.webp" alt="{{$nproduct->name}}">
                                </div>

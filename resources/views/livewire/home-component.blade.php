                        ...
                        <div class="row align-items-center slider-animated-1">
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-1" src="assets/imgs/slider/image3.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row align-items-center slider-animated-1">
                            <div class="col-lg-5 col-md-6">
                                <div class="hero-slider-content-2">
                                    ...
                                    <h2 class="animated fw-900">Liquid Trending</h2>
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-2" src="assets/imgs/slider/image1.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details',['slug'=>$poproduct->slug])}}" tabindex="0">
                                                <img class="default-img" src="{{ asset('assets/imgs/shop/product-')}}{{$poproduct->id}}.webp" alt="{{$poproduct->name}}">
                                                <img class="hover-img" src="{{ asset('assets/imgs/shop/product-')}}{{$poproduct->id}}.webp')}}" alt="">
                                            </a>
                                        </div>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <h2><a href="{{route('product.details',['slug'=>$poproduct->slug])}}">{{$poproduct->name}}</a></h2>
                                        ...
                                        <div class="product-price">
                                            <span>${{$poproduct->regular_price}} </span>
                                            {{--<span class="old-price">${{$poproduct->sale_price}}</span>--}}
                                        </div>
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store1({{ $poproduct->id}},'{{ $poproduct->name}}',{{ $poproduct->regular_price}}"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row product-grid-4">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details',['slug'=>$nproduct->slug])}}" tabindex="0">
                                                <img class="default-img" src="{{ asset('assets/imgs/shop/product-')}}{{$nproduct->id}}.webp" alt="{{$nproduct->name}}">
                                                <img class="hover-img" src="{{ asset('assets/imgs/shop/product-')}}{{$nproduct->id}}.webp')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-eye"></i></a>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store1({{$nproduct->id}},'{{$nproduct->name}}',{{$nproduct->regular_price}}"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{route('product.details',['slug'=>$product->slug])}}" tabindex="0">
                                                <img class="default-img" src="{{ asset('assets/imgs/shop/product-')}}{{$product->id}}.webp" alt="{{$product->name}}">
                                                <img class="hover-img" src="{{ asset('assets/imgs/shop/product-')}}{{$product->id}}.webp')}}" alt="">
                                            </a>
                                        </div>
                                        <div class="product-action-1">
                                            <a aria-label="Quick view" class="action-btn hover-up" data-bs-toggle="modal" data-bs-target="#quickViewModal"><i class="fi-rs-eye"></i></a>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-action-1 show">
                                            <a aria-label="Add To Cart" class="action-btn hover-up" href="#" wire:click.prevent="store1({{$product->id}},'{{$product->name}}',{{$product->regular_price}}"><i class="fi-rs-shopping-bag-add"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
